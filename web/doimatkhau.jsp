...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form" action="/doimatkhau" method="post">
                ...
                <div class="wrap-input100 validate-input" >
                    <input class="input100" type="text" name="maxacthuc" value="">
                    <span class="focus-input100"></span>
                    <span class="label-input100">Mã xác thực</span>
