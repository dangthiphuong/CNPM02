                                    ...
                                    <div class="about-team">
                                        <div class="container">
                                            ...
                                            <div class="box_register box_login form_container">
                                                ...
                                                <form class="form_register" action="<%=Util.fullPath("LoginU")%>">
                                                ...
                                                <ul class="login-fb">
                                                    <li class="link-login-fb">
                                                        ...
                                                        <a href="https://www.facebook.com/v3.2/dialog/oauth?client_id=617733695546668&amp;state=6e50082984233cb14646dae382eb9e0a&amp;response_type=code&amp;sdk=php-sdk-5.6.0&amp;redirect_uri=https%3A%2F%2Fdemo5019.web30s.vn%2Ffacebook-callback&amp;scope=email" class="btn-facebook">
                                                            Facebook
                                                        </a>
                                                    </li>
