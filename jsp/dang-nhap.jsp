                                        ...
                                        <div class="container">
                                            ...
                                            <div class="box_register box_login form_container">
                                                ...
                                                <form class="form_register"
                                                      action="<%=Util.fullPath("LoginU")%>?action=login" method="post">
                                                        ...
                                                        <div class="col-md-12 col-xs-12">
                                                            ...
                                                            <div class="group_input">
                                                                <label class="icon "><i class="fa fa-unlock-alt "
                                                                                        aria-hidden="true"></i></label>
                                                                <input id="passwords" name="passwords"
                                                                       required
                                                    ...
                                                    <ul class="ls_btn_submit">
                                                        ...
                                                        <%--                                                        <div id="captcha" class="g-recaptcha" type="submit"--%>
                                                        <%--                                                             onclick="checkCaptcha()"--%>
                                                        <%--                                                             data-sitekey="6LeqQbgZAAAAAMYTNH_38YkwyiRalFQQmTjW5N_9"--%>
                                                        <%--                                                             style="margin-left: 100px;margin-right: 314px"></div>--%>
                                                        ...
                                                        <div style="margin-top: 14px;margin-left: 77px;">
                                                            ...
                                                            <div style="width: 120px;height: 40px; margin-left: 189px;margin-top: -40px;text-align: center;z-index: 1"
                                                                ...
                                                                <input name="re-captcha" style="display: none" value="<%=err%>">
                                                            </div>
                                                            <script>
                                                                function random() {
                                                                    err =err+208;
